...
class ArmJoint:
    ...
    def get_positions(self, arm):
        ...
        if len(hist) > 0:
            ...
            return [1.4631597602903588, -0.14626462204760229, -0.056324096385235611, -1.4343614152262512, -0.046740446256051706, -0.098131293386130136, 0.037373684251193584]
        elif arm=='r':
            return  [-1.6675245720753284, -0.042128271706018502, 0.067388579404757509, -1.5225267784588195, -0.15132797946266643, -0.096956552543439156, -25.149484991162961]
        else:
